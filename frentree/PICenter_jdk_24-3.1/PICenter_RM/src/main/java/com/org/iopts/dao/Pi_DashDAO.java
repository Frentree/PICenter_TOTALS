...
public class Pi_DashDAO {	
	...
	public List<Map<String, Object>> selectDatatype_manager(Map<String, Object> type) throws Exception {
		return sqlSession.selectList(Namespace+".selectDatatype_manager", type);
	}
	...
	public List<Map<String, Object>> selectDashDataTodoApproval(Map<String, Object> map) throws Exception {
		return sqlSession.selectList(Namespace+".selectDashDataTodoApproval", map);
	}
	
	public List<Map<String, Object>> selectDashPieDraw(Map<String, Object> map) throws Exception {
		return sqlSession.selectList(Namespace+".selectDashPieDraw", map);
	}
	
	public List<Map<String, Object>> selectDashGridDrawData(Map<String, Object> map) throws Exception {
		return sqlSession.selectList(Namespace+".selectDashGridDrawData", map);
	}
	
	public List<Map<String, Object>> selectDashBarDrawDate(Map<String, Object> map) throws Exception {
		return sqlSession.selectList(Namespace+".selectDashBarDrawDate", map);
	}
	
	public List<Map<String, Object>> selectDashBarDrawMonthDate(Map<String, Object> map) throws Exception {
		return sqlSession.selectList(Namespace+".selectDashBarDrawMonthDate", map);
	}
	
	public Map<String, Object>selectDetectionTable(Map<String, Object> map) throws Exception {
		return sqlSession.selectOne(Namespace+".selectDetectionTable", map);
	}
	
	public Map<String, Object>selectApprovalTable(Map<String, Object> map) throws Exception {
		return sqlSession.selectOne(Namespace+".selectApprovalTable", map);
	}
	...
	public Map<String, Object> selectNoticePop(Map<String, Object> map) {
		return sqlSession.selectOne(Namespace+".selectNoticePop", map);
	}

	public Map<String, Object> selectDashDataPersonalServerCount(Map<String, Object> map) {
	...
	public List<Map<String, Object>> selectDashAllData(Map<String, Object> requestMap) {
		return sqlSession.selectList(Namespace + ".selectDashAllData",requestMap);
	}
	
	public List<Map<String, Object>> selectChkManagerTargetId(Map<String, Object> input) {
		return sqlSession.selectList(Namespace+".selectChkManagerTargetId", input);
	}
