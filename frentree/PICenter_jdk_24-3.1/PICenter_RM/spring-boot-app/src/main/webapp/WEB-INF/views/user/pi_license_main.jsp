...
// 			status = status.split('=');
			...
			var client = "${picSession.version.client_nm}";

			html += "<tr><th style=\"font-size : 18px; font-weight: bold;\" colspan=2>"+server+" - "+ status +"</th></tr>";
// 			html += "<tr><th style=\"font-size : 18px; font-weight: bold;\" colspan=2>서버 ( 10.131.21.71 ) - "+ status +"</th></tr>";
