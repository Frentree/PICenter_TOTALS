...
$(function() {
    ...
    .bind('select_node.jstree', function(evt, data, x) {
    	...
    	$(opener.document).find("#createServerGroupId").val(id);
		$(opener.document).find("#createServerGroupId").text(id);
...
$("#btnNoSelect, #btnSelect").click( function(e) {
	window.close();
});	
