  ...
  return function () {
    ...
    var t = {
        ...
        366: function _(t, e, i) {
          ...
          e.DDDraggable = function (t) {
            function e(e, i) {
              ...
              o.el = e, o.option = i, o.dragTransform = {
                xScale: 1,
                yScale: 1,
                xOffset: 0,
                yOffset: 0
              ...
              var n = i.handle.substring(1),
                r = e.gridstackNode;
              return o.dragEls = e.classList.contains(n) ? [e] : (null == r ? void 0 : r.subGrid) ? [e.querySelector(i.handle) || e] : Array.from(e.querySelectorAll(i.handle)), 0 === o.dragEls.length && (o.dragEls = [e]), o._mouseDown = o._mouseDown.bind(o), o._mouseMove = o._mouseMove.bind(o), o._mouseUp = o._mouseUp.bind(o), o._keyEvent = o._keyEvent.bind(o), o.enable(), o;
            }
            return n(e, t), e.prototype.on = function (e, i) {
              ...
              var e = this;
              !1 !== this.disabled && (t.prototype.enable.call(this), this.dragEls.forEach(function (t) {
                t.addEventListener("mousedown", e._mouseDown), d.isTouch && (t.addEventListener("touchstart", d.touchstart), t.addEventListener("pointerdown", d.pointerdown));
              }), this.el.classList.remove("ui-draggable-disabled"));
            }, e.prototype.disable = function (e) {
              var i = this;
              void 0 === e && (e = !1), !0 !== this.disabled && (t.prototype.disable.call(this), this.dragEls.forEach(function (t) {
                t.removeEventListener("mousedown", i._mouseDown), d.isTouch && (t.removeEventListener("touchstart", d.touchstart), t.removeEventListener("pointerdown", d.pointerdown));
              }), e || this.el.classList.add("ui-draggable-disabled"));
            }, e.prototype.destroy = function () {
              this.dragTimeout && window.clearTimeout(this.dragTimeout), delete this.dragTimeout, this.mouseDownEvent && this._mouseUp(this.mouseDownEvent), this.disable(!0), delete this.el, delete this.helper, delete this.option, t.prototype.destroy.call(this);
              ...
              if (!s.DDManager.mouseHandled) return 0 !== t.button || !this.dragEls.find(function (e) {
                return e === t.target;
              }) && t.target.closest('input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle') || this.option.cancel && t.target.closest(this.option.cancel) || (this.mouseDownEvent = t, delete this.dragging, delete s.DDManager.dragElement, delete s.DDManager.dropElement, document.addEventListener("mousemove", this._mouseMove, {
                capture: !0,
                passive: !0
              }), document.addEventListener("mouseup", this._mouseUp, !0), d.isTouch && (t.target.addEventListener("touchmove", d.touchmove), t.target.addEventListener("touchend", d.touchend)), t.preventDefault(), document.activeElement && document.activeElement.blur(), s.DDManager.mouseHandled = !0), !0;
              ...
              if (this.lastDrag = t, this.dragging) {
                ...
                var r = null === (e = this.el.gridstackNode) || void 0 === e ? void 0 : e.grid;
                r ? s.DDManager.dropElement = r.el.ddElement.ddDroppable : delete s.DDManager.dropElement, this.helper = this._createHelper(t), this._setupHelperContainmentStyle(), this.dragTransform = a.Utils.getValuesFromTransformedElement(this.helperContainment), this.dragOffset = this._getDragOffset(t, this.el, this.helperContainment), this._setupHelperStyle(t);
                var l = a.Utils.initEvent(t, {
                  target: this.el,
                  type: "dragstart"
                });
                this.option.start && this.option.start(l, this.ui()), this.triggerEvent("dragstart", l), document.addEventListener("keydown", this._keyEvent);
              }
              return !0;
            }, e.prototype._mouseUp = function (t) {
              var e, i;
              if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), d.isTouch && (t.target.removeEventListener("touchmove", d.touchmove, !0), t.target.removeEventListener("touchend", d.touchend, !0)), this.dragging) {
                delete this.dragging, null === (e = this.el.gridstackNode) || void 0 === e || delete e._origRotate, document.removeEventListener("keydown", this._keyEvent), (null === (i = s.DDManager.dropElement) || void 0 === i ? void 0 : i.el) === this.el.parentElement && delete s.DDManager.dropElement, this.helperContainment.style.position = this.parentOriginStylePosition || null, this.helper === this.el ? this._removeHelperStyle() : this.helper.remove();
                var o = a.Utils.initEvent(t, {
                  target: this.el,
                  type: "dragstop"
                });
                this.option.stop && this.option.stop(o), this.triggerEvent("dragstop", o), s.DDManager.dropElement && s.DDManager.dropElement.drop(t);
              }
            ...
            }, e.prototype._keyEvent = function (t) {
              var e = this.el.gridstackNode;
              if (null == e ? void 0 : e.grid) {
                var i = e.grid;
                if ("Escape" === t.key) e._origRotate && (e._orig = e._origRotate, delete e._origRotate), i.engine.restoreInitial(), this._mouseUp(this.mouseDownEvent);else if ("r" === t.key || "R" === t.key) {
                  if (!a.Utils.canBeRotated(e)) return;
                  e._origRotate = e._origRotate || r({}, e._orig), delete e._moving, i.setAnimation(!1).rotate(e.el, {
                    top: -this.dragOffset.offsetTop,
                    left: -this.dragOffset.offsetLeft
                  }).setAnimation(), e._moving = !0, this.dragOffset = this._getDragOffset(this.lastDrag, e.el, this.helperContainment), this.helper.style.width = this.dragOffset.width + "px", this.helper.style.height = this.dragOffset.height + "px", a.Utils.swap(e._orig, "w", "h"), delete e._rect, this._mouseMove(this.lastDrag);
                }
              }
            }, e.prototype._createHelper = function (t) {
              var i = this,
                o = this.el;
              return "function" == typeof this.option.helper ? o = this.option.helper(t) : "clone" === this.option.helper && (o = a.Utils.cloneNode(this.el)), document.body.contains(o) || a.Utils.appendTo(o, "parent" === this.option.appendTo ? this.el.parentElement : this.option.appendTo), o === this.el && (this.dragElementOriginStyle = e.originStyleProp.map(function (t) {
                return i.el.style[t];
              })), o;
              ...
              return i.pointerEvents = "none", i.width = this.dragOffset.width + "px", i.height = this.dragOffset.height + "px", i.willChange = "left, top", i.position = "fixed", this._dragFollow(t), i.transition = "none", setTimeout(function () {
              ...
              var e = this.helper.style,
                i = this.dragOffset;
              e.left = (t.clientX + i.offsetLeft - 0) * this.dragTransform.xScale + "px", e.top = (t.clientY + i.offsetTop - 0) * this.dragTransform.yScale + "px";
              ...
              var o = 0,
                n = 0;
              i && (o = this.dragTransform.xOffset, n = this.dragTransform.yOffset);
              var r = e.getBoundingClientRect();
              return {
                left: r.left,
                top: r.top,
                offsetLeft: -t.clientX + r.left - o,
                offsetTop: -t.clientY + r.top - n,
              ...
              return {
                position: {
                  top: (e.top - t.top) * this.dragTransform.yScale,
                  left: (e.left - t.left) * this.dragTransform.xScale
                }
              };
        ...
        677: function _(t, e, i) {
          var _o2,
            n = this && this.__extends || (_o2 = function o(t, e) {
              ...
              _o2(t, e), t.prototype = null === e ? Object.create(e) : (i.prototype = e.prototype, new i());
            }),
            r = this && this.__assign || function () {
              return r = Object.assign || function (t) {
                for (var e, i = 1, o = arguments.length; i < o; i++) for (var n in e = arguments[i]) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
            ...
            h = function (t) {
              ...
              return n(e, t), e.prototype.on = function (e, i) {
                ...
                if (s.DDManager.dragElement && this._canDrop(s.DDManager.dragElement.el)) {
                  t.preventDefault(), t.stopPropagation(), s.DDManager.dropElement && s.DDManager.dropElement !== this && s.DDManager.dropElement._mouseLeave(t, !0), s.DDManager.dropElement = this;
              ...
              }, e.prototype._mouseLeave = function (t, e) {
                var i;
                if (void 0 === e && (e = !1), s.DDManager.dragElement && s.DDManager.dropElement === this) {
                  t.preventDefault(), t.stopPropagation();
                  var o = l.Utils.initEvent(t, {
                    target: this.el,
                    type: "dropout"
                  });
                  if (this.option.out && this.option.out(o, this._ui(s.DDManager.dragElement)), this.triggerEvent("dropout", o), s.DDManager.dropElement === this && (delete s.DDManager.dropElement, !e)) {
                    for (var n = void 0, r = this.el.parentElement; !n && r;) n = null === (i = r.ddElement) || void 0 === i ? void 0 : i.ddDroppable, r = r.parentElement;
                    n && n._mouseEnter(t);
                  }
                }
            ...
            a = function () {
              ...
              return t.prototype.resizable = function (t, e, i, n) {
                return this._getDDElements(t).forEach(function (t) {
                  var r;
                  if ("disable" === e || "enable" === e) t.ddResizable && t.ddResizable[e]();else if ("destroy" === e) t.ddResizable && t.cleanResizable();else if ("option" === e) t.setupResizable(((r = {})[i] = n, r));else {
                    var s = t.el.gridstackNode.grid,
                      a = t.el.getAttribute("gs-resize-handles") || s.opts.resizable.handles || "e,s,se";
                    "all" === a && (a = "n,e,s,w,se,sw,ne,nw");
                    var l = !s.opts.alwaysShowResizeHandle;
                    t.setupResizable(o(o(o({}, s.opts.resizable), {
                      handles: a,
                      autoHide: l
                    }), {
                      start: e.start,
                ...
                return this._getDDElements(t).forEach(function (t) {
                  var r;
                  if ("disable" === e || "enable" === e) t.ddDraggable && t.ddDraggable[e]();else if ("destroy" === e) t.ddDraggable && t.cleanDraggable();else if ("option" === e) t.setupDraggable(((r = {})[i] = n, r));else {
                    var s = t.el.gridstackNode.grid;
                    t.setupDraggable(o(o({}, s.opts.draggable), {
                      start: e.start,
                      stop: e.stop,
                      drag: e.drag
                    }));
                ...
                var o = i.map(function (t) {
                  return t.ddElement || (e ? s.DDElement.init(t) : null);
                });
        ...
        664: function _(t, e, i) {
          ...
          e.DDResizableHandle = function () {
            ...
            return t.prototype._init = function () {
              ...
              return e.classList.add("ui-resizable-handle"), e.classList.add("".concat(t.prefix).concat(this.dir)), e.style.zIndex = "100", e.style.userSelect = "none", this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), o.isTouch && (this.el.addEventListener("touchstart", o.touchstart), this.el.addEventListener("pointerdown", o.pointerdown)), this;
            }, t.prototype.destroy = function () {
              ...
              this.mouseDownEvent = t, document.addEventListener("mousemove", this._mouseMove, {
                capture: !0,
                passive: !0
              }), document.addEventListener("mouseup", this._mouseUp, !0), o.isTouch && (this.el.addEventListener("touchmove", o.touchmove), this.el.addEventListener("touchend", o.touchend)), t.stopPropagation(), t.preventDefault();
              ...
              this.moving && (this._triggerEvent("stop", t), document.removeEventListener("keydown", this._keyEvent)), document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), o.isTouch && (this.el.removeEventListener("touchmove", o.touchmove), this.el.removeEventListener("touchend", o.touchend)), delete this.moving, delete this.mouseDownEvent, t.stopPropagation(), t.preventDefault();
            }, t.prototype._keyEvent = function (t) {
              var e, i;
              "Escape" === t.key && (null === (i = null === (e = this.host.gridstackNode) || void 0 === e ? void 0 : e.grid) || void 0 === i || i.engine.restoreInitial(), this._mouseUp(this.mouseDownEvent));
            }, t.prototype._triggerEvent = function (t, e) {
              return this.option[t] && this.option[t](e), this;
            }, t.prefix = "ui-resizable-", t;
          }();
        },
        904: function _(t, e, i) {
          var _o3,
            n = this && this.__extends || (_o3 = function o(t, e) {
              ...
              _o3(t, e), t.prototype = null === e ? Object.create(e) : (i.prototype = e.prototype, new i());
            });
          Object.defineProperty(e, "__esModule", {
            value: !0
          ...
          e.DDResizable = function (t) {
            function e(e, i) {
              void 0 === i && (i = {});
              var o = t.call(this) || this;
              return o.el = e, o.option = i, o.rectScale = {
                x: 1,
                y: 1
              }, o._ui = function () {
                ...
                return {
                  position: {
                    left: (i.left - t.left) * o.rectScale.x,
                    top: (i.top - t.top) * o.rectScale.y
                  },
                  size: {
                    width: i.width * o.rectScale.x,
                    height: i.height * o.rectScale.y
                  }
                };
              }, o._mouseOver = o._mouseOver.bind(o), o._mouseOut = o._mouseOut.bind(o), o.enable(), o._setupAutoHide(o.option.autoHide), o._setupHandlers(), o;
            }
            return n(e, t), e.prototype.on = function (e, i) {
              t.prototype.on.call(this, e, i);
            }, e.prototype.off = function (e) {
              ...
              t.prototype.enable.call(this), this.el.classList.remove("ui-resizable-disabled"), this._setupAutoHide(this.option.autoHide);
            }, e.prototype.disable = function () {
              t.prototype.disable.call(this), this.el.classList.add("ui-resizable-disabled"), this._setupAutoHide(!1);
            }, e.prototype.destroy = function () {
              this._removeHandlers(), this._setupAutoHide(!1), delete this.el, t.prototype.destroy.call(this);
            }, e.prototype.updateOption = function (t) {
              var e = this,
              ...
              var t = this;
              return this.handlers = this.option.handles.split(",").map(function (t) {
                return t.trim();
              }).map(function (e) {
                return new r.DDResizableHandle(t.el, e, {
              ...
              this.sizeToContent = a.Utils.shouldSizeToContent(this.el.gridstackNode, !0), this.originalRect = this.el.getBoundingClientRect(), this.scrollEl = a.Utils.getScrollElement(this.el), this.scrollY = this.scrollEl.scrollTop, this.scrolled = 0, this.startEvent = t, this._setupHelper(), this._applyChange();
              var e = a.Utils.initEvent(t, {
                type: "resizestart",
                target: this.el
              });
              ...
              var t = this;
              this.elOriginStyleVal = e._originStyleProp.map(function (e) {
                return t.el.style[e];
              }), this.parentOriginStylePosition = this.el.parentElement.style.position;
              var i = this.el.parentElement,
                o = a.Utils.getValuesFromTransformedElement(i);
              ...
              var i,
                ...
                s = t.clientX - n.clientX,
                a = this.sizeToContent ? 0 : t.clientY - n.clientY;
              e.indexOf("e") > -1 ? r.width += s : e.indexOf("w") > -1 && (r.width -= s, r.left += s, i = !0), e.indexOf("s") > -1 ? r.height += a : e.indexOf("n") > -1 && (r.height -= a, r.top += a, o = !0);
              var l = this._constrainSize(r.width, r.height, i, o);
              return Math.round(r.width) !== Math.round(l.width) && (e.indexOf("w") > -1 && (r.left += r.width - l.width), r.width = l.width), Math.round(r.height) !== Math.round(l.height) && (e.indexOf("n") > -1 && (r.top += r.height - l.height), r.height = l.height), r;
            }, e.prototype._constrainSize = function (t, e, i, o) {
              var n = this.option,
                r = (i ? n.maxWidthMoveLeft : n.maxWidth) || Number.MAX_SAFE_INTEGER,
                s = n.minWidth / this.rectScale.x || t,
                a = (o ? n.maxHeightMoveUp : n.maxHeight) || Number.MAX_SAFE_INTEGER,
                l = n.minHeight / this.rectScale.y || e;
              return {
                width: Math.min(r, Math.max(s, t)),
                height: Math.min(a, Math.max(l, e))
              };
              ...
              return this.temporalRect ? (Object.keys(this.temporalRect).forEach(function (t) {
                var o = e.temporalRect[t],
                  n = "width" === t || "left" === t ? e.rectScale.x : "height" === t || "top" === t ? e.rectScale.y : 1;
                e.el.style[t] = (o - i[t]) * n + "px";
              }), this) : this;
        ...
        537: function _(t, e, i) {
          ...
          e.touchstart = function (t) {
            n.touchHandled || (n.touchHandled = !0, r(t, "mousedown"));
          }, e.touchmove = function (t) {
            n.touchHandled && r(t, "mousemove");
        ...
        506: function _(t, e, i) {
          ...
          e.GridStackEngine = function () {
            ...
            return t.prototype.batchUpdate = function (t, e) {
              return void 0 === t && (t = !0), void 0 === e && (e = !0), !!this.batchMode === t || (this.batchMode = t, t ? (this._prevFloat = this._float, this._float = !0, this.cleanNodes(), this.saveInitial()) : (this._float = this._prevFloat, delete this._prevFloat, e && this._packNodes(), this._notify())), this;
            ...
            }, t.prototype._fixCollisions = function (t, e, i, r) {
              ...
              var s = e;
              !this._loading && this._useEntireRowArea(t, e) && (s = {
                x: 0,
                w: this.column,
                y: e.y,
                h: e.h
              }, i = this.collide(t, s, r.skip));
              for (var a = !1, l = {
                  nested: !0,
                  pack: !1
                }; i = i || this.collide(t, s, r.skip);) {
                var d = void 0;
                if (i.locked || this._loading || t._moving && !t._skipDown && e.y > t.y && !this["float"] && (!this.collide(i, o(o({}, i), {
                  y: t.y
                }), t) || !this.collide(i, o(o({}, i), {
                  y: e.y - i.h
                }), t)) ? (t._skipDown = t._skipDown || e.y > t.y, d = this.moveNode(t, o(o(o({}, e), {
                  y: i.y + i.h
                }), l)), (i.locked || this._loading) && d ? n.Utils.copyPos(e, t) : !i.locked && d && r.pack && (this._packNodes(), e.y = i.y + i.h, n.Utils.copyPos(t, e)), a = a || d) : d = this.moveNode(i, o(o(o({}, i), {
                  y: e.y + e.h,
                  skip: t
                }), l)), !d) return a;
                i = void 0;
              ...
              return this.nodes.find(function (t) {
                return t._id !== o && t._id !== r && n.Utils.isIntercepted(t, e);
              });
              ...
              if (e.rect && t._rect) {
                ...
                for (var a = .5, l = 0, d = i; l < d.length; l++) {
                  var h = d[l];
                  if (h.locked || !h._rect) break;
                  var u = h._rect,
                    c = Number.MAX_VALUE,
                    p = Number.MAX_VALUE;
                  r.y < u.y ? c = (s.y + s.h - u.y) / u.h : r.y + r.h > u.y + u.h && (c = (u.y + u.h - s.y) / u.h), r.x < u.x ? p = (s.x + s.w - u.x) / u.w : r.x + r.w > u.x + u.w && (p = (u.x + u.w - s.x) / u.w);
                  var g = Math.min(p, c);
                  g > a && (a = g, n = h);
                }
                return e.collide = n, n;
              }
            }, t.prototype.cacheRects = function (t, e, i, o, n, r) {
              return this.nodes.forEach(function (s) {
                return s._rect = {
                  y: s.y * e + i,
                  x: s.x * t + r,
                  w: s.w * t - r - o,
              ...
              return void 0 === t && (t = 1), this.nodes = n.Utils.sort(this.nodes, t), this;
            }, t.prototype._packNodes = function () {
              var t = this;
              return this.batchMode || (this.sortNodes(), this["float"] ? this.nodes.forEach(function (e) {
                if (!e._updating && void 0 !== e._orig && e.y !== e._orig.y) for (var i = e.y; i > e._orig.y;) --i, t.collide(e, {
                  x: e.x,
                  y: i,
                  w: e.w,
                  h: e.h
              ...
              var o;
              e._id = null !== (o = e._id) && void 0 !== o ? o : t._idSeq++, void 0 !== e.x && void 0 !== e.y && null !== e.x && null !== e.y || (e.autoPosition = !0);
              var r = {
                x: 0,
                y: 0,
                w: 1,
              ...
              return n.Utils.defaults(e, r), e.autoPosition || delete e.autoPosition, e.noResize || delete e.noResize, e.noMove || delete e.noMove, n.Utils.sanitizeMinMax(e), "string" == typeof e.x && (e.x = Number(e.x)), "string" == typeof e.y && (e.y = Number(e.y)), "string" == typeof e.w && (e.w = Number(e.w)), "string" == typeof e.h && (e.h = Number(e.h)), isNaN(e.x) && (e.x = r.x, e.autoPosition = !0), isNaN(e.y) && (e.y = r.y, e.autoPosition = !0), isNaN(e.w) && (e.w = r.w), isNaN(e.h) && (e.h = r.h), this.nodeBoundFix(e, i), e;
            }, t.prototype.nodeBoundFix = function (t, e) {
              var i = t._orig || n.Utils.copyPos({}, t);
              if (t.maxW && (t.w = Math.min(t.w, t.maxW)), t.maxH && (t.h = Math.min(t.h, t.maxH)), t.minW && t.minW <= this.column && (t.w = Math.max(t.w, t.minW)), t.minH && (t.h = Math.max(t.h, t.minH)), (t.x || 0) + (t.w || 1) > this.column && this.column < 12 && !this._inColumnResize && t._id && -1 === this.findCacheLayout(t, 12)) {
                var r = o({}, t);
                r.autoPosition || void 0 === r.x ? (delete r.x, delete r.y) : r.x = Math.min(11, r.x), r.w = Math.min(12, r.w || 1), this.cacheOneLayout(r, 12);
              }
              return t.w > this.column ? t.w = this.column : t.w < 1 && (t.w = 1), this.maxRow && t.h > this.maxRow ? t.h = this.maxRow : t.h < 1 && (t.h = 1), t.x < 0 && (t.x = 0), t.y < 0 && (t.y = 0), t.x + t.w > this.column && (e ? t.w = this.column - t.x : t.x = this.column - t.w), this.maxRow && t.y + t.h > this.maxRow && (e ? t.h = this.maxRow - t.y : t.y = this.maxRow - t.h), n.Utils.samePos(t, i) || (t._dirty = !0), this;
              ...
              for (var r = o ? o.y * i + (o.x + o.w) : 0, s = !1, a = function a(o) {
                  var r = o % i,
                    a = Math.floor(o / i);
                  ...
                  }) || (t.x === r && t.y === a || (t._dirty = !0), t.x = r, t.y = a, delete t.autoPosition, s = !0);
                }, l = r; !s; ++l) a(l);
              return s;
              ...
              return void 0 === e && (e = !1), this.nodes.find(function (e) {
                return e._id === t._id;
              }) || (this._inColumnResize ? this.nodeBoundFix(t) : this.prepareNode(t), delete t._temporaryRemoved, delete t._removeDOM, t.autoPosition && this.findEmptyPosition(t, this.nodes, this.column, i) && (delete t.autoPosition, o = !0), this.nodes.push(t), e && this.addedNodes.push(t), o || this._fixCollisions(t), this.batchMode || this._packNodes()._notify(), t);
              ...
              return void 0 === e && (e = !0), void 0 === i && (i = !1), this.nodes.find(function (e) {
                ...
                return e._id !== t._id;
              }), t._isAboutToRemove || this._packNodes(), this._notify([t]), this) : this;
            }, t.prototype.removeAll = function (t, e) {
              if (void 0 === t && (t = !0), void 0 === e && (e = !0), delete this._layouts, !this.nodes.length) return this;
              t && this.nodes.forEach(function (t) {
              ...
              var a = new t({
                ...
                nodes: this.nodes.map(function (t) {
                  return t._id === e._id ? r = o({}, t) : o({}, t);
                })
              });
              if (!r) return !1;
              var l = a.moveNode(r, i) && a.getRow() <= Math.max(this.getRow(), this.maxRow);
              ...
              var i, o, r;
              if (!t || !e) return !1;
              void 0 !== e.pack || this.batchMode || (r = e.pack = !0), "number" != typeof e.x && (e.x = t.x), "number" != typeof e.y && (e.y = t.y), "number" != typeof e.w && (e.w = t.w), "number" != typeof e.h && (e.h = t.h);
              var s = t.w !== e.w || t.h !== e.h,
                a = n.Utils.copyPos({}, t, !0);
              if (n.Utils.copyPos(a, e), this.nodeBoundFix(a, s), n.Utils.copyPos(e, a), !e.forceCollide && n.Utils.samePos(t, e)) return !1;
              var l = n.Utils.copyPos({}, t),
                d = this.collideAll(t, a, e.skip),
                h = !0;
              if (d.length) {
                var u = t._moving && !e.nested,
                  c = u ? this.directionCollideCoverage(t, e, d) : d[0];
                if (u && c && (null === (o = null === (i = t.grid) || void 0 === i ? void 0 : i.opts) || void 0 === o ? void 0 : o.subGridDynamic) && !t.grid._isTemp) {
                  var p = n.Utils.areaIntercept(e.rect, c._rect),
                    g = n.Utils.area(e.rect),
                    m = n.Utils.area(c._rect);
                  p / (g < m ? g : m) > .8 && (c.grid.makeSubGrid(c.el, void 0, t), c = void 0);
                }
                c ? h = !this._fixCollisions(t, a, c, e) : (h = !1, r && delete e.pack);
              }
              ...
              return this.sortNodes(), this.nodes.forEach(function (i) {
                var r = null == s ? void 0 : s.find(function (t) {
                    return t._id === i._id;
                  }),
                  l = o(o({}, i), r || {});
                n.Utils.removeInternalForSave(l, !t), e && e(i, l), a.push(l);
              }), a;
              ...
              return !this._layouts || this._inColumnResize || this._layouts.forEach(function (i, o) {
                ...
                if (o < e.column) e._layouts[o] = void 0;else {
                  var n = o / e.column;
                  t.forEach(function (t) {
                    if (t._orig) {
                      ...
                      e && (e.y >= 0 && t.y !== t._orig.y && (e.y += t.y - t._orig.y), t.x !== t._orig.x && (e.x = Math.round(t.x * n)), t.w !== t._orig.w && (e.w = Math.round(t.w * n)));
                    }
                  });
                }
              }), this;
            }, t.prototype.columnChanged = function (t, e, i) {
              var o,
                r = this;
              if (void 0 === i && (i = "moveScale"), !this.nodes.length || !e || t === e) return this;
              if ("none" === i) return this;
              var s = "compact" === i || "list" === i;
              s && this.sortNodes(1), e < t && this.cacheLayout(this.nodes, t), this.batchUpdate();
              var a = [],
                l = s ? this.nodes : n.Utils.sort(this.nodes, -1);
              if (e > t && this._layouts) {
                var d = this._layouts[e] || [],
                  h = this._layouts.length - 1;
                !d.length && t !== h && (null === (o = this._layouts[h]) || void 0 === o ? void 0 : o.length) && (t = h, this._layouts[h].forEach(function (t) {
                  var e,
                    i,
                    o,
                    n = l.find(function (e) {
                  ...
                  n && (s || t.autoPosition || (n.x = null !== (e = t.x) && void 0 !== e ? e : n.x, n.y = null !== (i = t.y) && void 0 !== i ? i : n.y), n.w = null !== (o = t.w) && void 0 !== o ? o : n.w, null != t.x && void 0 !== t.y || (n.autoPosition = !0));
                  ...
                  if (-1 !== n) {
                    var d = l[n];
                    if (s) return void (d.w = t.w);
                    (t.autoPosition || isNaN(t.x) || isNaN(t.y)) && r.findEmptyPosition(t, a), t.autoPosition || (d.x = null !== (e = t.x) && void 0 !== e ? e : d.x, d.y = null !== (i = t.y) && void 0 !== i ? i : d.y, d.w = null !== (o = t.w) && void 0 !== o ? o : d.w, a.push(d)), l.splice(n, 1);
                  }
                });
              }
              if (s) this.compact(i, !1);else {
                if (l.length) if ("function" == typeof i) i(e, t, a, l);else {
                  var u = s ? 1 : e / t,
                    c = "move" === i || "moveScale" === i,
                    p = "scale" === i || "moveScale" === i;
                  l.forEach(function (i) {
                    i.x = 1 === e ? 0 : c ? Math.round(i.x * u) : Math.min(i.x, e - 1), i.w = 1 === e || 1 === t ? 1 : p ? Math.round(i.w * u) || 1 : Math.min(i.w, e), a.push(i);
                  }), l = [];
                }
                a = n.Utils.sort(a, -1), this._inColumnResize = !0, this.nodes = [], a.forEach(function (t) {
                  r.addNode(t, !1), delete t._orig;
                });
              }
              return this.nodes.forEach(function (t) {
                return delete t._orig;
              }), this.batchUpdate(!1, !s), delete this._inColumnResize, this;
              ...
              return e.forEach(function (e, i) {
                var o;
                if (void 0 === e._id) {
                  var s = e.id ? n.nodes.find(function (t) {
                    return t.id === e.id;
                  }) : void 0;
                  e._id = null !== (o = null == s ? void 0 : s._id) && void 0 !== o ? o : t._idSeq++;
                }
                r[i] = {
                  x: e.x,
                  y: e.y,
              ...
              }), this._layouts = o ? [] : this._layouts || [], this._layouts[i] = r, this;
              ...
              (e.autoPosition || void 0 === e.x) && (delete n.x, delete n.y, e.autoPosition && (n.autoPosition = !0)), this._layouts = this._layouts || [], this._layouts[i] = this._layouts[i] || [];
            ...
            }, t.prototype.removeNodeFromLayoutCache = function (t) {
              if (this._layouts) for (var e = 0; e < this._layouts.length; e++) {
                var i = this.findCacheLayout(t, e);
                -1 !== i && this._layouts[e].splice(i, 1);
              }
          ...
          r(i(855), e), r(i(867), e), r(i(506), e), r(i(502), e), e.GridStack = function () {
            function t(e, i) {
              ...
              var n,
                ...
                h,
                p = this;
              this.el = e, this.opts = i, this._gsEventHandler = {}, this._extraDragRow = 0, this.dragTransform = {
                xScale: 1,
                yScale: 1,
                xOffset: 0,
                yOffset: 0
              }, e.gridstack = this, i = i || {}, e.classList.contains("grid-stack") || this.el.classList.add("grid-stack"), i.row && (i.minRow = i.maxRow = i.row, delete i.row);
              var g = l.Utils.toNumber(e.getAttribute("gs-row"));
              "auto" === i.column && delete i.column, void 0 !== i.alwaysShowResizeHandle && (i._alwaysShowResizeHandle = i.alwaysShowResizeHandle);
              var m = null === (n = i.columnOpts) || void 0 === n ? void 0 : n.breakpoints,
                f = i;
              if (f.oneColumnModeDomSort && (delete f.oneColumnModeDomSort, console.log("warning: Gridstack oneColumnModeDomSort no longer supported. Use GridStackOptions.columnOpts instead.")), f.oneColumnSize || !1 === f.disableOneColumnMode) {
                var v = f.oneColumnSize || 768;
                delete f.oneColumnSize, delete f.disableOneColumnMode, i.columnOpts = i.columnOpts || {};
                var y = (m = i.columnOpts.breakpoints = i.columnOpts.breakpoints || []).find(function (t) {
                  return 1 === t.c;
                });
                y ? y.w = v : (y = {
                  c: 1,
              ...
              var _ = i.columnOpts;
              _ && (_.columnWidth || (null === (r = _.breakpoints) || void 0 === r ? void 0 : r.length) ? _.columnMax = _.columnMax || 12 : (delete i.columnOpts, m = void 0)), (null == m ? void 0 : m.length) > 1 && m.sort(function (t, e) {
                return (e.w || 0) - (t.w || 0);
              });
              var b = o(o({}, l.Utils.cloneDeep(d.gridDefaults)), {
                column: l.Utils.toNumber(e.getAttribute("gs-column")) || d.gridDefaults.column,
                minRow: g || l.Utils.toNumber(e.getAttribute("gs-min-row")) || d.gridDefaults.minRow,
                maxRow: g || l.Utils.toNumber(e.getAttribute("gs-max-row")) || d.gridDefaults.maxRow,
              ...
              e.getAttribute("gs-animate") && (b.animate = l.Utils.toBool(e.getAttribute("gs-animate"))), i = l.Utils.defaults(i, b), this._initMargin(), this.checkDynamicColumn(), this.el.classList.add("gs-" + i.column), "auto" === i.rtl && (i.rtl = "rtl" === e.style.direction), i.rtl && this.el.classList.add("grid-stack-rtl");
              var w = null === (s = this.el.parentElement) || void 0 === s ? void 0 : s.parentElement,
                E = (null == w ? void 0 : w.classList.contains(d.gridDefaults.itemClass)) ? w.gridstackNode : void 0;
              E && (E.subGrid = this, this.parentGridItem = E, this.el.classList.add("grid-stack-nested"), E.el.classList.add("grid-stack-sub-grid")), this._isAutoCellHeight = "auto" === i.cellHeight, this._isAutoCellHeight || "initial" === i.cellHeight ? this.cellHeight(void 0, !1) : ("number" == typeof i.cellHeight && i.cellHeightUnit && i.cellHeightUnit !== d.gridDefaults.cellHeightUnit && (i.cellHeight = i.cellHeight + i.cellHeightUnit, delete i.cellHeightUnit), this.cellHeight(i.cellHeight, !1)), "mobile" === i.alwaysShowResizeHandle && (i.alwaysShowResizeHandle = u.isTouch), this._styleSheetClass = "gs-id-" + a.GridStackEngine._idSeq++, this.el.classList.add(this._styleSheetClass), this._setStaticClass();
              var D = i.engineClass || t.engineClass || a.GridStackEngine;
              if (this.engine = new D({
                ...
                onChange: function onChange(t) {
                  var e = 0;
                  p.engine.nodes.forEach(function (t) {
                    e = Math.max(e, t.y + t.h);
                  }), t.forEach(function (t) {
                    var e = t.el;
                    e && (t._removeDOM ? (e && e.remove(), delete t._removeDOM) : p._writePosAttr(e, t));
                  }), p._updateStyles(!1, e);
                }
              }), this._updateStyles(!1, 0), i.auto && (this.batchUpdate(), this.engine._loading = !0, this.getGridItems().forEach(function (t) {
                return p._prepareElement(t);
              }), delete this.engine._loading, this.batchUpdate(!1)), i.children) {
                var x = i.children;
                delete i.children, x.length && this.load(x);
              }
              this.setAnimation(), i.subGridDynamic && !c.DDManager.pauseDrag && (c.DDManager.pauseDrag = !0), void 0 !== (null === (h = i.draggable) || void 0 === h ? void 0 : h.pause) && (c.DDManager.pauseDrag = i.draggable.pause), this._setupRemoveDrop(), this._setupAcceptWidget(), this._updateResizeEvent();
            }
            return t.init = function (e, i) {
              if (void 0 === e && (e = {}), void 0 === i && (i = ".grid-stack"), "undefined" == typeof document) return null;
              ...
              var o = [];
              return "undefined" == typeof document || (t.getGridElements(i).forEach(function (i) {
                i.gridstack || (i.gridstack = new t(i, l.Utils.cloneDeep(e))), o.push(i.gridstack);
              ...
              if (n.gridstack) {
                var r = n.gridstack;
                return i && (r.opts = o(o({}, r.opts), i)), void 0 !== i.children && r.load(i.children), r;
              }
              if (!e.classList.contains("grid-stack") || t.addRemoveCB) if (t.addRemoveCB) n = t.addRemoveCB(e, i, !0, !0);else {
              ...
              var o, n, r;
              if ("string" == typeof e) (s = document.implementation.createHTMLDocument("")).body.innerHTML = e, o = s.body.children[0];else if (0 === arguments.length || 1 === arguments.length && (void 0 !== (r = e).el || void 0 !== r.x || void 0 !== r.y || void 0 !== r.w || void 0 !== r.h || void 0 !== r.content)) {
                if (null == (n = i = e) ? void 0 : n.el) o = n.el;else if (t.addRemoveCB) o = t.addRemoveCB(this.el, i, !0, !1);else {
                  var s,
                    a = (null == i ? void 0 : i.content) || "";
              ...
              if (o) {
                ...
                return i = l.Utils.cloneDeep(i) || {}, l.Utils.defaults(i, d), n = this.engine.prepareNode(i), this._writeAttr(o, i), this.el.appendChild(o), this.makeWidget(o, i), o;
              }
              ...
              for (var c, p = this; p && !h;) h = null === (a = p.opts) || void 0 === a ? void 0 : a.subGridOpts, p = null === (d = p.parentGridItem) || void 0 === d ? void 0 : d.grid;
              i = l.Utils.cloneDeep(o(o(o({}, h || {}), {
                children: void 0
              }), i || u.subGridOpts || {})), u.subGridOpts = i, "auto" === i.column && (c = !0, i.column = Math.max(u.w || 1, (null == n ? void 0 : n.w) || 1), delete i.columnOpts);
              var g,
                m,
                f = u.el.querySelector(".grid-stack-item-content");
              if (r) {
                if (this._removeDD(u.el), m = o(o({}, u), {
                  x: 0,
                  y: 0
                }), l.Utils.removeInternalForSave(m), delete m.subGridOpts, u.content && (m.content = u.content, delete u.content), t.addRemoveCB) g = t.addRemoveCB(this.el, m, !0, !1);else {
                  var v = document.implementation.createHTMLDocument("");
                  v.body.innerHTML = '<div class="grid-stack-item"></div>', (g = v.body.children[0]).appendChild(f), v.body.innerHTML = '<div class="grid-stack-item-content"></div>', f = v.body.children[0], u.el.appendChild(f);
                }
                this._prepareDragDropByNode(u);
              }
              if (n) {
                var y = c ? i.column : u.w,
                  _ = u.h + n.h,
                  b = u.el.style;
              ...
              return (null == n ? void 0 : n._moving) && (w._isTemp = !0), c && (w._autoColumn = !0), r && w.addWidget(g, m), n && (n._moving ? window.setTimeout(function () {
              ...
              }), o.batchUpdate(!1), this.parentGridItem && delete this.parentGridItem.subGrid, delete this.parentGridItem, t && window.setTimeout(function () {
              ...
              if (n.forEach(function (t) {
                ...
                r.marginBottom === r.marginTop && r.marginRight === r.marginLeft && r.marginTop === r.marginRight && (r.margin = r.marginTop, delete r.marginTop, delete r.marginRight, delete r.marginBottom, delete r.marginLeft), r.rtl === ("rtl" === this.el.style.direction) && (r.rtl = "auto"), this._isAutoCellHeight && (r.cellHeight = "auto"), this._autoColumn && (r.column = "auto");
              ...
              var n,
                r = this;
              void 0 === i && (i = t.addRemoveCB || !0), e = l.Utils.cloneDeep(e);
              var a = this.getColumn();
              e.forEach(function (t) {
                t.w = t.w || 1, t.h = t.h || 1;
              }), e = l.Utils.sort(e);
              var d = 0;
              e.forEach(function (t) {
                d = Math.max(d, (t.x || 0) + t.w);
              }), d > a && (this._ignoreLayoutsNodeChange = !0, this.engine.cacheLayout(e, d, !0));
              var h = t.addRemoveCB;
              "function" == typeof i && (t.addRemoveCB = i);
              var u = [];
              this.batchUpdate();
              var c = !this.engine.nodes.length;
              c && this.setAnimation(!1), !c && i && s([], this.engine.nodes, !0).forEach(function (i) {
                i.id && (l.Utils.find(e, i.id) || (t.addRemoveCB && t.addRemoveCB(r.el, i, !1, !1), u.push(i), r.removeWidget(i.el, !0, !1)));
              }), this.engine._loading = !0;
              var p = [];
              return this.engine.nodes = this.engine.nodes.filter(function (t) {
                return !l.Utils.find(e, t.id) || (p.push(t), !1);
              }), e.forEach(function (t) {
                var e,
                  n = l.Utils.find(p, t.id);
                if (n) {
                  if (l.Utils.shouldSizeToContent(n) && (t.h = n.h), r.engine.nodeBoundFix(t), (t.autoPosition || void 0 === t.x || void 0 === t.y) && (t.w = t.w || n.w, t.h = t.h || n.h, r.engine.findEmptyPosition(t)), r.engine.nodes.push(n), l.Utils.samePos(n, t) && r.moveNode(n, o(o({}, t), {
                    forceCollide: !0
                  })), r.update(n.el, t), null === (e = t.subGridOpts) || void 0 === e ? void 0 : e.children) {
                    var s = n.el.querySelector(".grid-stack");
                    s && s.gridstack && s.gridstack.load(t.subGridOpts.children);
                  }
                } else i && r.addWidget(t);
              }), delete this.engine._loading, this.engine.removedNodes = u, this.batchUpdate(!1), delete this._ignoreLayoutsNodeChange, h ? t.addRemoveCB = h : delete t.addRemoveCB, c && (null === (n = this.opts) || void 0 === n ? void 0 : n.animate) && this.setAnimation(this.opts.animate, !0), this;
            }, t.prototype.batchUpdate = function (t) {
              return void 0 === t && (t = !0), this.engine.batchUpdate(t), t || (this._updateContainerHeight(), this._triggerRemoveEvent(), this._triggerAddEvent(), this._triggerChangeEvent()), this;
              ...
              if (void 0 === e && (e = !0), e && void 0 !== t && this._isAutoCellHeight !== ("auto" === t) && (this._isAutoCellHeight = "auto" === t, this._updateResizeEvent()), "initial" !== t && "auto" !== t || (t = void 0), void 0 === t) {
                var i = -this.opts.marginRight - this.opts.marginLeft + this.opts.marginTop + this.opts.marginBottom;
                t = this.cellWidth() + i;
              }
              var o = l.Utils.parseHeight(t);
              return this.opts.cellHeightUnit === o.unit && this.opts.cellHeight === o.h || (this.opts.cellHeightUnit = o.unit, this.opts.cellHeight = o.h, this.resizeToContentCheck(), e && this._updateStyles(!0)), this;
            }, t.prototype.cellWidth = function () {
              return this._widthOrContainer() / this.getColumn();
            }, t.prototype._widthOrContainer = function (t) {
              var e;
              return void 0 === t && (t = !1), t && (null === (e = this.opts.columnOpts) || void 0 === e ? void 0 : e.breakpointForWindow) ? window.innerWidth : this.el.clientWidth || this.el.parentElement.clientWidth || window.innerWidth;
            }, t.prototype.checkDynamicColumn = function () {
              var t,
                e,
                i = this.opts.columnOpts;
              if (!i || !i.columnWidth && !(null === (t = i.breakpoints) || void 0 === t ? void 0 : t.length)) return !1;
              var o = this.getColumn(),
                n = o,
                r = this._widthOrContainer(!0);
              if (i.columnWidth) n = Math.min(Math.round(r / i.columnWidth) || 1, i.columnMax);else {
                n = i.columnMax;
                for (var s = 0; s < i.breakpoints.length && r <= i.breakpoints[s].w;) n = i.breakpoints[s++].c || o;
              }
              if (n !== o) {
                var a = null === (e = i.breakpoints) || void 0 === e ? void 0 : e.find(function (t) {
                  return t.c === n;
                });
                return this.column(n, (null == a ? void 0 : a.layout) || i.layout), !0;
              }
              return !1;
            }, t.prototype.compact = function (t, e) {
              return void 0 === t && (t = "compact"), void 0 === e && (e = !0), this.engine.compact(t, e), this._triggerChangeEvent(), this;
            }, t.prototype.column = function (t, e) {
              if (void 0 === e && (e = "moveScale"), !t || t < 1 || this.opts.column === t) return this;
              ...
              return this._updateContainerHeight(), n.subGridOpts && this.makeSubGrid(o, n.subGridOpts, void 0, !1), 1 === this.opts.column && (this._ignoreLayoutsNodeChange = !0), this._triggerAddEvent(), this._triggerChangeEvent(), delete this._ignoreLayoutsNodeChange, o;
            }, t.prototype.on = function (t, e) {
              var i = this;
              ...
              } else "drag" === t || "dragstart" === t || "dragstop" === t || "resizestart" === t || "resize" === t || "resizestop" === t || "dropped" === t || "resizecontent" === t ? this._gsEventHandler[t] = e : console.error("GridStack.on(" + t + ") event not supported");
              return this;
            }, t.prototype.off = function (t) {
              var e = this;
              ...
              return void 0 === i && (i = !0), void 0 === o && (o = !0), t.getElements(e).forEach(function (e) {
                if (!e.parentElement || e.parentElement === n.el) {
                  ...
                  r || (r = n.engine.nodes.find(function (t) {
                    return e === t.el;
                  })), r && (i && t.addRemoveCB && t.addRemoveCB(n.el, r, !1, !1), delete e.gridstackNode, n._removeDD(e), n.engine.removeNode(r, i, o), i && e.parentElement && e.remove());
                }
              }), o && (this._triggerRemoveEvent(), this._triggerChangeEvent()), this;
            }, t.prototype.removeAll = function (e, i) {
              var o = this;
              return void 0 === e && (e = !0), void 0 === i && (i = !0), this.engine.nodes.forEach(function (i) {
                e && t.addRemoveCB && t.addRemoveCB(o.el, i, !1, !1), delete i.el.gridstackNode, o.opts.staticGrid || o._removeDD(i.el);
              }), this.engine.removeAll(e, i), i && this._triggerRemoveEvent(), this;
            }, t.prototype.setAnimation = function (t, e) {
              var i = this;
              return void 0 === t && (t = this.opts.animate), e ? setTimeout(function () {
                i.opts && i.setAnimation(t);
              }) : t ? this.el.classList.add("grid-stack-animate") : this.el.classList.remove("grid-stack-animate"), this;
            }, t.prototype.hasAnimationCSS = function () {
              return this.el.classList.contains("grid-stack-animate");
            }, t.prototype.setStatic = function (t, e, i) {
              var o = this;
              return void 0 === e && (e = !0), void 0 === i && (i = !0), !!this.opts.staticGrid === t || (t ? this.opts.staticGrid = !0 : delete this.opts.staticGrid, this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach(function (n) {
              ...
              return t.getElements(e).forEach(function (t) {
                var e,
                  n = null == t ? void 0 : t.gridstackNode;
                if (n) {
                  var r = l.Utils.cloneDeep(i);
                  o.engine.nodeBoundFix(r), delete r.autoPosition, delete r.id;
                  var s,
                    a = ["x", "y", "w", "h"];
                  if (a.some(function (t) {
                    return void 0 !== r[t] && r[t] !== n[t];
                  }) && (s = {}, a.forEach(function (t) {
                    s[t] = void 0 !== r[t] ? r[t] : n[t], delete r[t];
                  })), !s && (r.minW || r.minH || r.maxW || r.maxH) && (s = {}), void 0 !== r.content) {
                    var d = t.querySelector(".grid-stack-item-content");
                    d && d.innerHTML !== r.content && (d.innerHTML = r.content, (null === (e = n.subGrid) || void 0 === e ? void 0 : e.el) && (d.appendChild(n.subGrid.el), n.subGrid.opts.styleInHead || n.subGrid._updateStyles(!0))), delete r.content;
                  }
                  var h = !1,
                    u = !1;
                  for (var c in r) "_" !== c[0] && n[c] !== r[c] && (n[c] = r[c], h = !0, u = u || !o.opts.staticGrid && ("noResize" === c || "noMove" === c || "locked" === c));
                  if (l.Utils.sanitizeMinMax(n), s) {
                    var p = void 0 !== s.w && s.w !== n.w;
                    o.moveNode(n, s), o.resizeToContentCheck(p, n), delete n._orig;
                  }
                  (s || h) && o._writeAttr(t, n), u && o._prepareDragDropByNode(n);
                }
              }), this;
            }, t.prototype.moveNode = function (t, e) {
              var i = t._updating;
            ...
            }, t.prototype.resizeToContent = function (e) {
              var i, o;
              if (e && (e.classList.remove("size-to-content-max"), e.clientHeight)) {
                ...
                if (n) {
                  ...
                  if (r && e.parentElement === r.el) {
                    var s = r.getCellHeight(!0);
                    if (s) {
                      var a,
                        l = n.h ? n.h * s : e.clientHeight;
                      if (n.resizeToContentParent && (a = e.querySelector(n.resizeToContentParent)), a || (a = e.querySelector(t.resizeToContentParent)), a) {
                        var d,
                          h = e.clientHeight - a.clientHeight,
                          u = n.h ? n.h * s - h : a.clientHeight;
                        if (n.subGrid) d = n.subGrid.getRow() * n.subGrid.getCellHeight(!0);else {
                          if (null === (o = null === (i = n.subGridOpts) || void 0 === i ? void 0 : i.children) || void 0 === o ? void 0 : o.length) return;
                          var c = a.firstElementChild;
                          if (!c) return void console.error("Error: GridStack.resizeToContent() widget id:".concat(n.id, " '").concat(t.resizeToContentParent, "'.firstElementChild is null, make sure to have a div like container. Skipping sizing."));
                          d = c.getBoundingClientRect().height || u;
                        }
                        if (u !== d) {
                          l += d - u;
                          var p = Math.ceil(l / s),
                            g = Number.isInteger(n.sizeToContent) ? n.sizeToContent : 0;
                          g && p > g && (p = g, e.classList.add("size-to-content-max")), n.minH && p < n.minH ? p = n.minH : n.maxH && p > n.maxH && (p = n.maxH), p !== n.h && (r._ignoreLayoutsNodeChange = !0, r.moveNode(n, {
                            h: p
                          }), delete r._ignoreLayoutsNodeChange);
                        }
                      }
                    }
                  }
              ...
              return t.getElements(e).forEach(function (t) {
                ...
                if (l.Utils.canBeRotated(e)) {
                  ...
                  if (i) {
                    var r = i.left > 0 ? Math.floor(i.left / o.cellWidth()) : 0,
                      s = i.top > 0 ? Math.floor(i.top / o.opts.cellHeight) : 0;
                    n.x = e.x + r - (e.h - (s + 1)), n.y = e.y + s - r;
                  }
                  Object.keys(n).forEach(function (t) {
                    void 0 === n[t] && delete n[t];
                  });
                  var a = e._orig;
                  o.update(t, n), e._orig = a;
                }
              }), this;
              ...
              var t;
              if (this.engine.batchMode) return this;
              if (null === (t = this.engine.addedNodes) || void 0 === t ? void 0 : t.length) {
                this._ignoreLayoutsNodeChange || this.engine.layoutsNodesChange(this.engine.addedNodes), this.engine.addedNodes.forEach(function (t) {
                  delete t._dirty;
                });
                var e = s([], this.engine.addedNodes, !0);
              ...
              var t;
              if (this.engine.batchMode) return this;
              if (null === (t = this.engine.removedNodes) || void 0 === t ? void 0 : t.length) {
                var e = s([], this.engine.removedNodes, !0);
              ...
              if (this._styles) {
                var t = this.opts.styleInHead ? void 0 : this.el.parentNode;
                l.Utils.removeStylesheet(this._styleSheetClass, t), delete this._styles;
              }
              return this;
            }, t.prototype._updateStyles = function (t, e) {
              if (void 0 === t && (t = !1), t && this._removeStylesheet(), void 0 === e && (e = this.getRow()), this._updateContainerHeight(), 0 === this.opts.cellHeight) return this;
              ...
              if (!this._styles) {
                ...
                if (this._styles = l.Utils.createStylesheet(this._styleSheetClass, r, {
                ...
                var s = this.opts.marginTop + this.opts.marginUnit,
                  ...
                  c = ".".concat(this._styleSheetClass, " > .grid-stack-placeholder > .placeholder-content");
                l.Utils.addCSSRule(this._styles, u, "top: ".concat(s, "; right: ").concat(d, "; bottom: ").concat(a, "; left: ").concat(h, ";")), l.Utils.addCSSRule(this._styles, c, "top: ".concat(s, "; right: ").concat(d, "; bottom: ").concat(a, "; left: ").concat(h, ";")), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-n"), "top: ".concat(s, ";")), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-s"), "bottom: ".concat(a)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-ne"), "right: ".concat(d)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-e"), "right: ".concat(d)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-se"), "right: ".concat(d, "; bottom: ").concat(a)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-nw"), "left: ".concat(h)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-w"), "left: ".concat(h)), l.Utils.addCSSRule(this._styles, "".concat(n, " > .ui-resizable-sw"), "left: ".concat(h, "; bottom: ").concat(a));
              }
              if ((e = e || this._styles._max) > this._styles._max) {
                for (var p = function p(t) {
                    return i * t + o;
                  }, g = this._styles._max + 1; g <= e; g++) l.Utils.addCSSRule(this._styles, "".concat(n, '[gs-y="').concat(g, '"]'), "top: ".concat(p(g))), l.Utils.addCSSRule(this._styles, "".concat(n, '[gs-h="').concat(g + 1, '"]'), "height: ".concat(p(g + 1)));
                this._styles._max = e;
              }
              return this;
            }, t.prototype._updateContainerHeight = function () {
              if (!this.engine || this.engine.batchMode) return this;
              var t = this.parentGridItem,
                e = this.getRow() + this._extraDragRow,
                i = this.opts.cellHeight,
                o = this.opts.cellHeightUnit;
              if (!i) return this;
              if (!t) {
                var n = l.Utils.parseHeight(getComputedStyle(this.el).minHeight);
                if (n.h > 0 && n.unit === o) {
                  var r = Math.floor(n.h / i);
                  e < r && (e = r);
                }
              }
              return this.el.setAttribute("gs-current-row", String(e)), this.el.style.removeProperty("min-height"), this.el.style.removeProperty("height"), e && (this.el.style[t ? "minHeight" : "height"] = e * i + o), t && !t.grid.engine.batchMode && l.Utils.shouldSizeToContent(t) && t.grid.resizeToContentCBCheck(t.el), this;
            }, t.prototype._prepareElement = function (t, e, i) {
              void 0 === e && (e = !1), i = i || this._readAttr(t), t.gridstackNode = i, i.el = t, i.grid = this, i = this.engine.addNode(i, e), this._writeAttr(t, i), t.classList.add(d.gridDefaults.itemClass, this.opts.itemClass);
              var o = l.Utils.shouldSizeToContent(i);
              return o ? t.classList.add("size-to-content") : t.classList.remove("size-to-content"), o && this.resizeToContentCheck(!1, i), this._prepareDragDropByNode(i), this;
            }, t.prototype._writePosAttr = function (t, e) {
              return void 0 !== e.x && null !== e.x && t.setAttribute("gs-x", String(e.x)), void 0 !== e.y && null !== e.y && t.setAttribute("gs-y", String(e.y)), e.w > 1 ? t.setAttribute("gs-w", String(e.w)) : t.removeAttribute("gs-w"), e.h > 1 ? t.setAttribute("gs-h", String(e.h)) : t.removeAttribute("gs-h"), this;
              ...
              if ((null === (t = this.el) || void 0 === t ? void 0 : t.clientWidth) && this.prevWidth !== this.el.clientWidth) {
                ...
                var e = !1;
                return this._autoColumn && this.parentGridItem ? this.opts.column !== this.parentGridItem.w && (this.column(this.parentGridItem.w, "none"), e = !0) : e = this.checkDynamicColumn(), this._isAutoCellHeight && this.cellHeight(), this.engine.nodes.forEach(function (t) {
            ...
            }, t.prototype.resizeToContentCheck = function (t, e) {
              var i = this;
              if (void 0 === t && (t = !1), void 0 === e && (e = void 0), this.engine) {
                if (t && this.hasAnimationCSS()) return setTimeout(function () {
                  return i.resizeToContentCheck(!1, e);
                }, 310);
                if (e) l.Utils.shouldSizeToContent(e) && this.resizeToContentCBCheck(e.el);else if (this.engine.nodes.some(function (t) {
                  return l.Utils.shouldSizeToContent(t);
                })) {
                  var o = s([], this.engine.nodes, !0);
                  this.batchUpdate(), o.forEach(function (t) {
                    l.Utils.shouldSizeToContent(t) && i.resizeToContentCBCheck(t.el);
                  }), this.batchUpdate(!1);
                }
              ...
              var e = this;
              void 0 === t && (t = !1);
              var i = !this.parentGridItem && (this._isAutoCellHeight || this.opts.sizeToContent || this.opts.columnOpts || this.engine.nodes.find(function (t) {
                return t.sizeToContent;
              }));
              return t || !i || this.resizeObserver ? !t && i || !this.resizeObserver || (this.resizeObserver.disconnect(), delete this.resizeObserver, delete this._sizeThrottle) : (this._sizeThrottle = l.Utils.throttle(function () {
                return e.onResize();
              }, this.opts.cellHeightThrottle), this.resizeObserver = new ResizeObserver(function () {
                return e._sizeThrottle();
              }), this.resizeObserver.observe(this.el), this._skipInitialResize = !0), this;
              ...
              void 0 === i && (i = document), void 0 !== (null == e ? void 0 : e.pause) && (c.DDManager.pauseDrag = e.pause), e = o(o({}, d.dragInDefaultOptions), e || {});
              var n = "string" == typeof t ? l.Utils.getElements(t, i) : t;
              n.length && (null == n || n.forEach(function (t) {
                p.isDraggable(t) || p.dragIn(t, e);
              }));
              ...
              var i = this;
              return void 0 === e && (e = !0), this.opts.staticGrid || (t ? delete this.opts.disableDrag : this.opts.disableDrag = !0, this.engine.nodes.forEach(function (o) {
                i._prepareDragDropByNode(o), o.subGrid && e && o.subGrid.enableMove(t, e);
              })), this;
            }, t.prototype.enableResize = function (t, e) {
              var i = this;
              return void 0 === e && (e = !0), this.opts.staticGrid || (t ? delete this.opts.disableResize : this.opts.disableResize = !0, this.engine.nodes.forEach(function (o) {
                i._prepareDragDropByNode(o), o.subGrid && e && o.subGrid.enableResize(t, e);
              })), this;
            }, t.prototype._removeDD = function (t) {
              return p.draggable(t, "destroy").resizable(t, "destroy"), t.gridstackNode && delete t.gridstackNode._initDD, delete t.ddElement, this;
            }, t.prototype._setupAcceptWidget = function () {
              var e,
                i,
                n = this;
              if (this.opts.staticGrid || !this.opts.acceptWidgets && !this.opts.removable) return p.droppable(this.el, "destroy"), this;
              var r = function r(t, o, _r) {
                var s,
                  a,
                  d = o.gridstackNode;
                if (d) {
                  if (_r = _r || o, !(null === (a = d.grid) || void 0 === a ? void 0 : a.el)) {
                    _r.style.transform = "scale(".concat(1 / n.dragTransform.xScale, ",").concat(1 / n.dragTransform.yScale, ")");
                    var h = _r.getBoundingClientRect();
                    _r.style.left = h.x + (n.dragTransform.xScale - 1) * (t.clientX - h.x) / n.dragTransform.xScale + "px", _r.style.top = h.y + (n.dragTransform.yScale - 1) * (t.clientY - h.y) / n.dragTransform.yScale + "px", _r.style.transformOrigin = "0px 0px";
                  }
                  var u = n.el.getBoundingClientRect(),
                    c = (s = _r.getBoundingClientRect()).top,
                    g = s.left;
                  g -= u.left;
                  var m = {
                    position: {
                      top: (c -= u.top) * n.dragTransform.xScale,
                      left: g * n.dragTransform.yScale
                    }
                  };
                  if (d._temporaryRemoved) {
                    if (d.x = Math.max(0, Math.round(g / i)), d.y = Math.max(0, Math.round(c / e)), delete d.autoPosition, n.engine.nodeBoundFix(d), !n.engine.willItFit(d)) {
                      if (d.autoPosition = !0, !n.engine.willItFit(d)) return void p.off(o, "drag");
                      d._willFitPos && (l.Utils.copyPos(d, d._willFitPos), delete d._willFitPos);
                    }
                    n._onStartMoving(_r, t, m, d, i, e);
                  } else n._dragOrResize(_r, t, m, d, i, e);
                }
              };
              return p.droppable(this.el, {
                accept: function accept(t) {
                  var e = t.gridstackNode || n._readAttr(t, !1);
                  if ((null == e ? void 0 : e.grid) === n) return !0;
                  if (!n.opts.acceptWidgets) return !1;
                  var i = !0;
                  if ("function" == typeof n.opts.acceptWidgets) i = n.opts.acceptWidgets(t);else {
                    var o = !0 === n.opts.acceptWidgets ? ".grid-stack-item" : n.opts.acceptWidgets;
                    i = t.matches(o);
                  }
                  if (i && e && n.opts.maxRow) {
                    var r = {
                      w: e.w,
                      h: e.h,
                      minW: e.minW,
                    ...
                    i = n.engine.willItFit(r);
                  }
                  return i;
                }
              }).on(this.el, "dropover", function (s, a, l) {
                var d = a.gridstackNode;
                if ((null == d ? void 0 : d.grid) === n && !d._temporaryRemoved) return !1;
                (null == d ? void 0 : d.grid) && d.grid !== n && !d._temporaryRemoved && d.grid._leave(a, l), i = n.cellWidth(), e = n.getCellHeight(!0), d || (d = n._readAttr(a, !1)), d.grid || (d._isExternal = !0, a.gridstackNode = d), l = l || a;
                var h = d.w || Math.round(l.offsetWidth / i) || 1,
                  u = d.h || Math.round(l.offsetHeight / e) || 1;
                return d.grid && d.grid !== n ? (a._gridstackNodeOrig || (a._gridstackNodeOrig = d), a.gridstackNode = d = o(o({}, d), {
                  w: h,
                  h: u,
                  grid: n
                }), delete d.x, delete d.y, n.engine.cleanupNode(d).nodeBoundFix(d), d._initDD = d._isExternal = d._temporaryRemoved = !0) : (d.w = h, d.h = u, d._temporaryRemoved = !0), t._itemRemoving(d.el, !1), p.on(a, "drag", r), r(s, a, l), !1;
              }).on(this.el, "dropout", function (t, e, i) {
                var o = e.gridstackNode;
                return !!o && (o.grid && o.grid !== n || (n._leave(e, i), n._isTemp && n.removeAsSubGrid(o)), !1);
              }).on(this.el, "drop", function (t, e, i) {
                var r,
                  s,
                  a,
                  d = e.gridstackNode;
                if ((null == d ? void 0 : d.grid) === n && !d._isExternal) return !1;
                var h = !!n.placeholder.parentElement;
                n.placeholder.remove();
                var u = h && n.opts.animate;
                u && n.setAnimation(!1);
                var c = e._gridstackNodeOrig;
                if (delete e._gridstackNodeOrig, h && (null == c ? void 0 : c.grid) && c.grid !== n) {
                  var g = c.grid;
                  g.engine.removeNodeFromLayoutCache(c), g.engine.removedNodes.push(c), g._triggerRemoveEvent()._triggerChangeEvent(), g.parentGridItem && !g.engine.nodes.length && g.opts.subGridDynamic && g.removeAsSubGrid();
                }
                if (!d) return !1;
                if (h && (n.engine.cleanupNode(d), d.grid = n), null === (r = d.grid) || void 0 === r || delete r._isTemp, p.off(e, "drag"), i !== e ? (i.remove(), e.gridstackNode = c, h && (e = e.cloneNode(!0))) : (e.remove(), n._removeDD(e)), !h) return !1;
                e.gridstackNode = d, d.el = e;
                var m = null === (a = null === (s = d.subGrid) || void 0 === s ? void 0 : s.el) || void 0 === a ? void 0 : a.gridstack;
                return l.Utils.copyPos(d, n._readAttr(n.placeholder)), l.Utils.removePositioningStyles(e), n.el.appendChild(e), n._prepareElement(e, !0, d), m && (m.parentGridItem = d, m.opts.styleInHead || m._updateStyles(!0)), n._updateContainerHeight(), n.engine.addedNodes.push(d), n._triggerAddEvent(), n._triggerChangeEvent(), n.engine.endUpdate(), n._gsEventHandler.dropped && n._gsEventHandler.dropped(o(o({}, t), {
                  type: "dropped"
                }), c && c.grid ? c : void 0, d), u && n.setAnimation(n.opts.animate, !0), !1;
              }), this;
            }, t._itemRemoving = function (t, e) {
              var i = t ? t.gridstackNode : void 0;
              (null == i ? void 0 : i.grid) && !t.classList.contains(i.grid.opts.removableOptions.decline) && (e ? i._isAboutToRemove = !0 : delete i._isAboutToRemove, e ? t.classList.add("grid-stack-item-removing") : t.classList.remove("grid-stack-item-removing"));
              ...
              return e ? (this.opts.staticGrid || p.isDroppable(e) || p.droppable(e, this.opts.removableOptions).on(e, "dropover", function (e, i) {
              ...
              if (!t._initDD) {
                var r,
                  s,
                  a = function a(o, n) {
                    e._gsEventHandler[o.type] && e._gsEventHandler[o.type](o, o.target), r = e.cellWidth(), s = e.getCellHeight(!0), e._onStartMoving(i, o, n, t, r, s);
                  },
                  d = function d(o, n) {
                    e._dragOrResize(i, o, n, t, r, s);
                  },
                  h = function h(o) {
                    e.placeholder.remove(), delete t._moving, delete t._event, delete t._lastTried;
                    var n = t.w !== t._orig.w,
                      r = o.target;
                    if (r.gridstackNode && r.gridstackNode.grid === e) {
                      if (t.el = r, t._isAboutToRemove) {
                        var s = i.gridstackNode.grid;
                        s._gsEventHandler[o.type] && s._gsEventHandler[o.type](o, r), s.engine.nodes.push(t), s.removeWidget(i, !0, !0);
                      } else l.Utils.removePositioningStyles(r), t._temporaryRemoved ? (l.Utils.copyPos(t, t._orig), e._writePosAttr(r, t), e.engine.addNode(t)) : e._writePosAttr(r, t), e._gsEventHandler[o.type] && e._gsEventHandler[o.type](o, r);
                      e._extraDragRow = 0, e._updateContainerHeight(), e._triggerChangeEvent(), e.engine.endUpdate(), "resizestop" === o.type && (Number.isInteger(t.sizeToContent) && (t.sizeToContent = t.h), e.resizeToContentCheck(n, t));
                    }
                  };
                p.draggable(i, {
                  start: a,
              ...
              return p.draggable(i, o ? "disable" : "enable").resizable(i, n ? "disable" : "enable"), this;
            }, t.prototype._onStartMoving = function (t, e, i, o, n, r) {
              var s;
              if (this.engine.cleanNodes().beginUpdate(o), this._writePosAttr(this.placeholder, o), this.el.appendChild(this.placeholder), this.placeholder.gridstackNode = o, null === (s = o.grid) || void 0 === s ? void 0 : s.el) this.dragTransform = l.Utils.getValuesFromTransformedElement(t);else if (this.placeholder && this.placeholder.closest(".grid-stack")) {
                var a = this.placeholder.closest(".grid-stack");
                this.dragTransform = l.Utils.getValuesFromTransformedElement(a);
              ...
              if (o.el = this.placeholder, o._lastUiPosition = i.position, o._prevYPix = i.position.top, o._moving = "dragstart" === e.type, delete o._lastTried, "dropover" === e.type && o._temporaryRemoved && (this.engine.addNode(o), o._moving = !0), this.engine.cacheRects(n, r, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft), "resizestart" === e.type) {
                var d = this.getColumn() - o.x,
                  h = (this.opts.maxRow || Number.MAX_SAFE_INTEGER) - o.y;
                p.resizable(t, "option", "minWidth", n * Math.min(o.minW || 1, d)).resizable(t, "option", "minHeight", r * Math.min(o.minH || 1, h)).resizable(t, "option", "maxWidth", n * Math.min(o.maxW || Number.MAX_SAFE_INTEGER, d)).resizable(t, "option", "maxWidthMoveLeft", n * Math.min(o.maxW || Number.MAX_SAFE_INTEGER, o.x + o.w)).resizable(t, "option", "maxHeight", r * Math.min(o.maxH || Number.MAX_SAFE_INTEGER, h)).resizable(t, "option", "maxHeightMoveUp", r * Math.min(o.maxH || Number.MAX_SAFE_INTEGER, o.y + o.h));
              }
              ...
              var a,
                ...
                g = Math.round(.1 * s),
                m = Math.round(.1 * r);
              if (h = Math.min(h, m), u = Math.min(u, m), c = Math.min(c, g), p = Math.min(p, g), "drag" === e.type) {
                if (n._temporaryRemoved) return;
                var f = i.position.top - n._prevYPix;
                n._prevYPix = i.position.top, !1 !== this.opts.draggable.scroll && l.Utils.updateScrollPosition(t, i.position, f);
                var v = i.position.left + (i.position.left > n._lastUiPosition.left ? -u : h),
                  y = i.position.top + (i.position.top > n._lastUiPosition.top ? -p : c);
                d.x = Math.round(v / r), d.y = Math.round(y / s);
                ...
                if (d.x < 0) return;
                if (l.Utils.updateScrollResize(e, t, s), d.w = Math.round((i.size.width - h) / r), d.h = Math.round((i.size.height - c) / s), n.w === d.w && n.h === d.h) return;
                if (n._lastTried && n._lastTried.w === d.w && n._lastTried.h === d.h) return;
                v = i.position.left + h;
                var E = i.position.top + c;
                d.x = Math.round(v / r), d.y = Math.round(E / s), a = !0;
              }
              n._event = e, n._lastTried = d;
              var D = {
                x: i.position.left + h,
                y: i.position.top + c,
                w: (i.size ? i.size.width : n.w * r) - h - u,
                h: (i.size ? i.size.height : n.h * s) - c - p
              };
              if (this.engine.moveNodeCheck(n, o(o({}, d), {
                ...
                n._lastUiPosition = i.position, this.engine.cacheRects(r, s, c, u, p, h), delete n._skipDown, a && n.subGrid && n.subGrid.onResize(), this._extraDragRow = 0, this._updateContainerHeight();
                var x = e.target;
                this._writePosAttr(x, n), this._gsEventHandler[e.type] && this._gsEventHandler[e.type](e, x);
              }
            }, t.prototype._leave = function (e, i) {
              var o = e.gridstackNode;
              o && ((i = i || e).style.transform = "scale(1)", p.off(e, "drag"), o._temporaryRemoved || (o._temporaryRemoved = !0, this.engine.removeNode(o), o.el = o._isExternal && i ? i : e, !0 === this.opts.removable && t._itemRemoving(e, !0), e._gridstackNodeOrig ? (e.gridstackNode = e._gridstackNodeOrig, delete e._gridstackNodeOrig) : o._isExternal && (delete o.el, delete e.gridstackNode, this.engine.restoreInitial())));
            }, t.prototype.commit = function () {
              return (0, l.obsolete)(this, this.batchUpdate(!1), "commit", "batchUpdate", "5.2"), this;
            }, t.resizeToContentParent = ".grid-stack-item-content", t.Utils = l.Utils, t.Engine = a.GridStackEngine, t.GDRev = "10.3.1", t;
          }();
        },
        855: function _(t, e) {
          Object.defineProperty(e, "__esModule", {
        ...
        867: function _(t, e) {
          ...
          Object.defineProperty(e, "__esModule", {
            ...
            var r = function r() {
              ...
              return console.warn("gridstack.js: Function `" + i + "` is deprecated in " + n + " and has been replaced with `" + o + "`. It will be **removed** in a future release"), e.apply(t, r);
            };
          ...
          var n = function () {
            ...
            return t.getElements = function (t, e) {
              if (void 0 === e && (e = document), "string" == typeof t) {
                ...
                return n.length || "." === t[0] || "#" === t[0] || (n = e.querySelectorAll("." + t)).length || (n = e.querySelectorAll("#" + t)), Array.from(n);
              }
              return [t];
              ...
              if (void 0 === e && (e = document), "string" == typeof t) {
                ...
                if (i && "#" === t[0]) return i.getElementById(t.substring(1));
                if ("#" === t[0] || "." === t[0] || "[" === t[0]) return e.querySelector(t);
                if (i && !isNaN(+t[0])) return i.getElementById(t);
                var o = e.querySelector(t);
                return i && !o && (o = i.getElementById(t)), o || (o = e.querySelector("." + t)), o;
              }
              return t;
            }, t.shouldSizeToContent = function (t, e) {
              return void 0 === e && (e = !1), (null == t ? void 0 : t.grid) && (e ? !0 === t.sizeToContent || !0 === t.grid.opts.sizeToContent && void 0 === t.sizeToContent : !!t.sizeToContent || t.grid.opts.sizeToContent && !1 !== t.sizeToContent);
              ...
              return t.sort(function (t, o) {
                var n,
                  ...
                  s,
                  a,
                  l = e * ((null !== (n = t.y) && void 0 !== n ? n : i) - (null !== (r = o.y) && void 0 !== r ? r : i));
                return 0 === l ? e * ((null !== (s = t.x) && void 0 !== s ? s : i) - (null !== (a = o.x) && void 0 !== a ? a : i)) : l;
              });
            }, t.find = function (t, e) {
            ...
            }, t.removeStylesheet = function (t, e) {
              var i = (e || document).querySelector("STYLE[gs-style-id=" + t + "]");
              ...
              var e,
                i = "px";
              if ("string" == typeof t) {
                if ("auto" === t || "" === t) e = 0;else {
                  var o = t.match(/^(-[0-9]+\.[0-9]+|[0-9]*\.[0-9]+|-[0-9]+|[0-9]+)(px|em|rem|vh|vw|%|cm|mm)?$/);
                  if (!o) throw new Error("Invalid height val = ".concat(t));
              ...
              return i.forEach(function (i) {
                for (var o in i) {
                  if (!i.hasOwnProperty(o)) return;
                  null === t[o] || void 0 === t[o] ? t[o] = i[o] : "object" == _typeof(i[o]) && "object" == _typeof(t[o]) && e.defaults(t[o], i[o]);
                }
              }), t;
            }, t.same = function (t, e) {
              if ("object" != _typeof(t)) return t == e;
              if (_typeof(t) != _typeof(e)) return !1;
              if (Object.keys(t).length !== Object.keys(e).length) return !1;
              for (var i in t) if (t[i] !== e[i]) return !1;
              return !0;
            }, t.copyPos = function (t, e, i) {
              return void 0 === i && (i = !1), void 0 !== e.x && (t.x = e.x), void 0 !== e.y && (t.y = e.y), void 0 !== e.w && (t.w = e.w), void 0 !== e.h && (t.h = e.h), i && (e.minW && (t.minW = e.minW), e.minH && (t.minH = e.minH), e.maxW && (t.maxW = e.maxW), e.maxH && (t.maxH = e.maxH)), t;
            ...
            }, t.removeInternalAndSame = function (e, i) {
              if ("object" == _typeof(e) && "object" == _typeof(i)) for (var o in e) {
                var n = e[o],
                  r = i[o];
                "_" === o[0] || n === r ? delete e[o] : n && "object" == _typeof(n) && void 0 !== r && (t.removeInternalAndSame(n, r), Object.keys(n).length || delete e[o]);
              }
              ...
              return null == t || "object" != _typeof(t) ? t : t instanceof Array ? o([], t, !0) : i({}, t);
            }, t.cloneDeep = function (e) {
              var i = ["parentGrid", "el", "grid", "subGrid", "engine"],
                o = t.clone(e),
                n = function n(_n) {
                  o.hasOwnProperty(_n) && "object" == _typeof(o[_n]) && "__" !== _n.substring(0, 2) && !i.find(function (t) {
                    return t === _n;
                  }) && (o[_n] = t.cloneDeep(e[_n]));
                };
              for (var r in o) n(r);
              return o;
              ...
              if (e instanceof Object) {
                var i = function i(_i) {
                  e.hasOwnProperty(_i) && (Array.isArray(e[_i]) ? e[_i].forEach(function (e) {
                    t.style[_i] = e;
                  }) : t.style[_i] = e[_i]);
                };
                for (var o in e) i(o);
              ...
              return ["altKey", "ctrlKey", "metaKey", "shiftKey"].forEach(function (e) {
                return o[e] = t[e];
            ...
            }, t.getValuesFromTransformedElement = function (e) {
              ...
              return e.removeChild(i), i.remove(), {
                xScale: 1 / o.width,
                yScale: 1 / o.height,
                xOffset: o.left,
                yOffset: o.top
            ...
            }, t.canBeRotated = function (t) {
              var e;
              return !(!t || t.w === t.h || t.locked || t.noResize || (null === (e = t.grid) || void 0 === e ? void 0 : e.opts.disableResize) || t.minW && t.minW === t.maxW || t.minH && t.minH === t.maxH);
            }, t;
          }();
          e.Utils = n;
        }
